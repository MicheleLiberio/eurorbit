...
function buildWeatherError(){
	...
	firstDiv.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="100px" height="100px" fill="currentColor" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">' +
